  ...
  return (
    <Card className="w-full shadow-lg border-0 bg-muted backdrop-blur-sm">
      <CardHeader className="space-y-1">
        <CardTitle className="text-2xl font-semibold">{isSignUp ? 'Create Account' : 'Sign In'}</CardTitle>
        <CardDescription>{isSignUp ? 'Create your workspace and start collaborating' : 'Enter your credentials to access your workspace'}</CardDescription>
      </CardHeader>
      <CardContent>
