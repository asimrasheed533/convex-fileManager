...
import { Search, Plus, MoreVertical, SearchIcon, CircleX } from 'lucide-react';
    ...
    >
      <div className="p-4 border-b border-border/50">
        ...
        <div className="relative">
          ...
          <Input placeholder="Search conversations..." className="pl-10 bg-background/50 border-border/50" />
        </div>
      </div>
